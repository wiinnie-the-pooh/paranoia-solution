...
//---------------------------------------------------------------------------
#include "parallel/test/corba/idl/Test_TaskFactoryA.hh"
...
#include "parallel/test/corba/server/Test_TaskFactoryA_i.hh"
#include "parallel/test/corba/server/Test_TaskFactoryB_i.hh"
