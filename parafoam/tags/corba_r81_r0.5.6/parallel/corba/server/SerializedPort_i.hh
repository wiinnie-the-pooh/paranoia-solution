...
//---------------------------------------------------------------------------
#ifndef corba_server_SerializedPort_i_hh
#define corba_server_SerializedPort_i_hh


//---------------------------------------------------------------------------
#include "parallel/corba/idl/SerializedPort.hh"
...
namespace parallel 
{
			    ...
			    virtual PortBase_i
  {
    ...
    typedef SerializedDataHolder_i TDataHolder_i;
  };
