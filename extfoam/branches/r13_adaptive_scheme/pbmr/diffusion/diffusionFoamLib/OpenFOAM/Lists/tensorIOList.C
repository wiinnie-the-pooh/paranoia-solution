...
namespace Foam
{
    ...
    defineTemplateTypeNameAndDebugWithName(tensorIOList, "tensorList", 0);
    defineTemplateTypeNameAndDebugWithName(tensorListIOList, "tensorListList", 0);
}
